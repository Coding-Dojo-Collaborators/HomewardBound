...
// Route Imports
import CatAdoptionRoutes from './CatAdoptionRoutes';
    ...
    <div style={contentDiv}>
      ...
      <div className="text-center">
        <Button
          ...
          tag={Link} href='https://www.petfinder.com/pet-adoption/cat-adoption/'
        >
          More Articles on Cat Adoption
        </Button>
      </div>
    </div>
  )
